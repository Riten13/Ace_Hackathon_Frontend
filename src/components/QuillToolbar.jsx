...
export const QuillToolbar = () => (
  <div id="toolbar" className="rounded-lg !border-none">
    ...
    {/* Buttons for text format - bold, italic, underline, strikethrough */}
    <span className="ql-formats">
    ...
    {/* Buttons to change text to subscript, superscript, quote */}
    <span className="ql-formats">
    ...
    {/* Buttons for text alignment, color, background. */}
    <span className="ql-formats">
